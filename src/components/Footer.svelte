...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> <a class="duration-200 text-violet-600 hover:text-violet-400" href="mailto:adi.more7000@gmail.com">adi.more7000@gmail.com</a></p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/adityamore7000" target="_blank" class="text-violet-400"
                >AdityaMore7000<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/aditya-more-9a095422a/" target="_blank" class="text-violet-400"
                >Aditya More<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
